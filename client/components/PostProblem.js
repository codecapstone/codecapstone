  ...
  render() {
    ...
    return (
      <div className="largeViewBorderCard">
        <div className="largeViewCard" id="admin">
          <h3 id="adminText">Congratulations you have special powers!</h3>
          <h3>Instructions</h3>

          <div>
            <h4>Enter your challenge/problem details here.</h4>
          </div>
          ...
          <div>
            ...
            >
              The git repo is here - You can get all the info from the completed
              exercises folder.
            </a>
          </div>
          ...
          <div>
            <a
              href="https://codesandbox.io/s/00v926lpjv"
              target="_blank"
              rel="noopener noreferrer"
            >
              The code sandbox template is here - make sure you fork it and
              change the name!
            </a>
          </div>
          <br />
